  ...
  <div class="auth-page">
    <div class="auth-container">
      ...
      <div class="social-auth">
        <button @click="signInWithGoogle" :disabled="loading" class="social-btn google-btn">
        ...
        <button @click="signInWithDiscord" :disabled="loading" class="social-btn discord-btn">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
