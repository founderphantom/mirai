...
export const PAUSE_DURATION_THRESHOLD_MS = 300; // Inworld best practice: Natural pause between phrases (300ms) - increase to reduce discarded LLM requests from interruption
